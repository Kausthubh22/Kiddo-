...
public class CBSEActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onStart() {
        ...
        mref1 = new Firebase("https://kiddo-1bc30.firebaseio.com/School database:/CBSE/List of CBSE schools/R N Gandhi School/Information of R N Gandhi School/" + path1);
    ...
    public void onItemSelected(final AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position == 1) {
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent123 = new Intent(CBSEActivity.this,CBSEmoredetails.class);
        ...
        if (position == 2) {
            Toast.makeText(parent.getContext(), "Select a r n gandhi ", Toast.LENGTH_SHORT).show();
        }
